...
docker build -t "registry.api.chichiapp.ir:4443/chichi/chichilanding:$build_version" . &&
docker push "registry.api.chichiapp.ir:4443/chichi/chichilanding:$build_version" &&
