...
import HeaderSignUp from "./SignUp/Sub/HeaderSignUp";
    ...
    render() {
        ...
        return (
            <div className='w-100 d-flex flex-column'>
                <div className='w-100   vh-FirstSectionHeight row m-0  '>
                    <div className='col-sm-12 col-md-5  justify-content-start d-inline-flex flex-column p-0 h-100 '>
                        <div className='w-100   justify-content-start  padding-top main-right-margin  d-inline-flex flex-column'>
                            <div className='w-100'>
                                <HeaderSignUp/>
                            </div>
                            ...
                            <div className='d-flex  firstField flex-column '>
                    ...
                    <div className='col-sm-12 col-md-7  vh-FirstSectionHeight padding-Zero '>
                         <img src={firstImg} alt={firstImg} className='Object-fill w-100  '/>
                     </div>
                </div>
                 <div className='vh-SecondSection'>
                </div>
{/************SecondPages**********/}
                <div className='vh-110 second-row w-100'>

                    <div className='  col-sm-12   col-md-5 padding-Zero h-100 mt-SecondSection '>
                        <img src={secondImg} alt={secondImg} className='Object-fill w-100'/>
                    </div>
                    <div className='col-sm-12 col-md-7'>

                        <div className='vh-select1-responsive'>
                ...
                {/***********thirdPage*********/}
                <div className='vh-ThirdSection'>
                </div>
                <div className='vh-70 row w-100 m-0'>

                    <div className='col-sm-12 col-md-5'>

                        <div className='vh-40-responsive'>

                        </div>

                        <div className='d-flex justify-content-start align-items-start flex-column text-right    main-right-margin' id='newFriend'>
                    ...
                    <div className='  col-sm-12   col-md-7 padding-Zero h-100 mt-SecondSection '>
                        <img src={thirdImg} alt={thirdImg} className='Object-fill w-100'/>
                    </div>
                    <div className='col-sm-12 col-md-7'>
                ...
                {/***********footer*******/}
                {/*<div className='vh-FirstSectionHeight'>*/}
                {/*</div>*/}
                {/*<div className='w-100 vh-40-responsive'>*/}
