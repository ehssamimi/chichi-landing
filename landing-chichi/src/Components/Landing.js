    ...
    render() {
        ...
        return (
            <div className='w-100 d-flex flex-column'>
                <div className='w-100 d-flex vh-70 '>
                    <div className='col-sm-12 col-md-5  justify-content-start d-inline-flex flex-column p-0 h-100 '>
                        <div className='w-100   justify-content-start  padding-top padding-Right  d-inline-flex flex-column'>
                            <div className='w-75'>
                                <HeaderSignUp/>
                            </div>
                            <div className='vh-10'>
                            ...
                            <div className='d-flex justify-content-start flex-column text-right'>
                                ...
                                <p className='mt-4 fs-1vw col-8'>
                                    اولین اپلیکشینی که با اون می توانید خیلی راحت و با بیشترین تخیف خرید کنید و خرید شما
                                    خیل سریع به منزل شما میاد!
                                </p>
                                <div className=' d-flex justify-content-start align-items-center vh-5 mt-4  '>
                                    <Link name="first" activeClass="active" className="first w-100" to="SignUp"
                    ...
                    <div className='col-sm-12 col-md-7  h-100 padding-Zero'>
                        {/*<div className='  col-12   p-0 vh-70 padding-Zero d-flex justify-content-start'>*/}
                        <img src={firstImg} alt={firstImg} className='Object-fill w-100  '/>
                        {/*</div>*/}
                    </div>

                </div>
                <div className='vh-110 d-flex  '>
                    <div className='  col-sm-12 col-md-5 padding-Zero h-100'>
