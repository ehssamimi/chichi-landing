...
class SIgnUpPage extends Component {
    constructor(props) {
        super(props);
        this.state={
            fields:{phoneNumber:'',Name:'',NewFriend:''},errors:{}
        }
    }
    ...
    render() {
        let{phoneNumber,Name,NewFriend}=this.state.fields;
        ...
        return (
            <div className=''>
                <div className='col-5   justify-content-end d-inline-flex flex-column p-0'>
                    ...
                    <div className='d-flex justify-content-start align-items-start flex-column text-right  ' id='SignUp'>
                        <h1 className='  fs-25vw text-bold'>دعوت از دوستان ! </h1>
                        ...
                        <form className='w-100 d-flex justify-content-start align-items-start flex-column text-center' onSubmit={this.submitNwFriend.bind(this)}>
                            ...
                            <div className='d-flex justify-content-center align-items-center col-6 h-100'>
                ...
                <div className='  col-7 float-left p-0 d-flex flex-column'>
                    ...
                    <div className='d-flex justify-content-center align-items-center flex-column text-center  ' id='newFriend'>
                        ...
                        <form className='w-100 d-flex justify-content-center align-items-center flex-column text-center' onSubmit={this.submitForm.bind(this)}>
                            ...
                            <span className="mt-2 fs-1vw">دوستانتان را دعوت  کنید</span>
                        </form>
                        {/*<div className=' d-flex justify-content-start align-items-center vh-5 mt-3 w-100 '>*/}
                        {/*<Button className='col-5 btn-blue-Color fs-1vw'>همین حالا ثبت نام کنید </Button>*/}
                        {/*</div>*/}
                ...
                <div className='w-100 vh-25'>
                    <div className='  bottomLanding d-flex justify-content-center align-items-center '  >
